...
include "connect.php";
$sql = "select * from pictures_gallery";
    ...
    <div class="row vertical-gap">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="nk-gallery-item-box">
                <a href="<?php echo $folder_photo . $each['image']; ?>" class="nk-gallery-item" data-size="1016x572">
                    <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                    <img src="<?php echo $folder_photo . $each['image']; ?>" alt="">
                </a>
